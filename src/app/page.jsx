      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            ...
            I’m the founder and CEO of Kiwi Dragon Creations LLC, where we focus
            on local manufacturing and and automation technology, and a weekend racecar driver.
          </p>
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://www.instagram.com/vincent.teune/"
